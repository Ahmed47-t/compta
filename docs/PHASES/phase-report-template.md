...
## 6. بروتوكول الإشعار وبدء المحادثة الجديدة (`Mandatory Sign-Off Box`)

> **تنبيه حاسم للـ AI Agent:** بعد حفظ هذا التقرير وفتح الـ Pull Request، يجب عليك عند الرد على المستخدم تضمين صندوق التنبيه الختامي (`🛑 إشعار إتمام المهمة وبدء محادثة جديدة`) المنصوص عليه في القسم 6 من `AGENTS.md` مع إرفاق البرومبت الجاهز للنسخ للخطوة التالية لتسهيل انتقال المستخدم إلى محادثة جديدة.
